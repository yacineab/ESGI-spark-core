...
object WikipediaRanking {
 ...
 val spark = ???
  ...
  /**
    ...
    * using WikipediaData.parse you can parse your rdd lignes (String) on Objet WikipediaArticle
    * The parse function is already written for you on WikipediaData.scala class
    *
